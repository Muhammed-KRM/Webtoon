...
# Discovery router must come before series router to avoid path conflicts
# (e.g., /series/trending vs /series/{series_id})
...
api_router.include_router(translation_editor.router, prefix="", tags=["Translation Editor"])
